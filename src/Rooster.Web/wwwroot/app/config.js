            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            files: ['/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js']
                        },
                        {
                            files: ['/plugins/jvectormap/jquery-jvectormap-world-mill-en.js']
                        },
                        {
                            name: 'ui.checkbox',
                    ...
                    return $ocLazyLoad.load([
                        {
                            reconfig: true,
                            serie: true,
                            files: ['/plugins/rickshaw/vendor/d3.v3.js','/plugins/rickshaw/rickshaw.min.js']
                        },
                        {
                            reconfig: true,
                            name: 'angular-rickshaw',
                            files: ['/plugins/rickshaw/angular-rickshaw.js']
                        }
                    ]);
                }
            }
        ...
        .state('charts.sparkline_chart', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['/plugins/sparkline/jquery.sparkline.min.js']
                        }
                    ]);
                }
            }
        ...
        .state('charts.chartjs_chart', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['/plugins/chartJs/Chart.min.js']
                        },
                        {
                            name: 'angles',
                            files: ['/plugins/chartJs/angles.js']
                        }
                    ]);
                }
            }
        ...
        .state('mailbox.inbox', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['css/plugins/iCheck/custom.css','/plugins/iCheck/icheck.min.js']
                        }
                    ]);
                }
            }
        ...
        .state('mailbox.email_compose', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['css/plugins/summernote/summernote.css','css/plugins/summernote/summernote-bs3.css','/plugins/summernote/summernote.min.js']
                        },
                        {
                            name: 'summernote',
                            files: ['css/plugins/summernote/summernote.css','css/plugins/summernote/summernote-bs3.css','/plugins/summernote/summernote.min.js','/plugins/summernote/angular-summernote.min.js']
                        }
                    ]);
                }
            }
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            files: ['/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js','/plugins/jvectormap/jquery-jvectormap-world-mill-en.js']
                        },
                        {
                            name: 'ui.checkbox',
                            files: ['/bower_components/angular-bootstrap-checkbox/angular-bootstrap-checkbox.js']
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            name: 'ui.knob',
                            files: ['/plugins/jsKnob/jquery.knob.js','/plugins/jsKnob/angular-knob.js']
                        },
                        {
                            files: ['css/plugins/ionRangeSlider/ion.rangeSlider.css','css/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css','/plugins/ionRangeSlider/ion.rangeSlider.min.js']
                        },
                        {
                            insertBefore: '#loadBefore',
                            name: 'localytics.directives',
                            files: ['css/plugins/chosen/chosen.css','/plugins/chosen/chosen.jquery.js','/plugins/chosen/chosen.js']
                        },
                        {
                            name: 'nouislider',
                            files: ['css/plugins/nouslider/jquery.nouislider.css','/plugins/nouslider/jquery.nouislider.min.js','/plugins/nouslider/angular-nouislider.js']
                        },
                        {
                            name: 'datePicker',
                            files: ['css/plugins/datapicker/angular-datapicker.css','/plugins/datapicker/datePicker.js']
                        },
                        {
                            files: ['/plugins/jasny/jasny-bootstrap.min.js']
                        },
                        {
                            name: 'ui.switchery',
                            files: ['css/plugins/switchery/switchery.css','/plugins/switchery/switchery.js','/plugins/switchery/ng-switchery.js']
                        },
                        {
                            name: 'colorpicker.module',
                            files: ['css/plugins/colorpicker/colorpicker.css','/plugins/colorpicker/bootstrap-colorpicker-module.js']
                        },
                        {
                            name: 'ngImgCrop',
                            files: ['/plugins/ngImgCrop/ng-img-crop.js','css/plugins/ngImgCrop/ng-img-crop.css']
                        }
        ...
        .state('forms.file_upload', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['css/plugins/dropzone/basic.css','css/plugins/dropzone/dropzone.css','/plugins/dropzone/dropzone.js']
                        }
                    ]);
                }
            }
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['css/plugins/fullcalendar/fullcalendar.css','/plugins/fullcalendar/fullcalendar.min.js','/plugins/fullcalendar/gcal.js']
                        },
                        {
                            name: 'ui.calendar',
                            files: ['/plugins/fullcalendar/calendar.js']
                        }
                    ]);
                }
            }
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            name: 'ui.sortable',
                            files: ['/plugins/ui-sortable/sortable.js']
                        }
                    ]);
                }
            }
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            serie: true,
                            files: ['css/plugins/codemirror/codemirror.css','css/plugins/codemirror/ambiance.css','/plugins/codemirror/codemirror.js','/plugins/codemirror/mode/javascript/javascript.js']
                        },
                        {
                            name: 'ui.codemirror',
                            files: ['/plugins/ui-codemirror/ui-codemirror.min.js']
                        }
                    ]);
                }
            }
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            name: 'ui.tree',
                            files: ['css/plugins/uiTree/angular-ui-tree.min.css','/plugins/uiTree/angular-ui-tree.min.js']
                        },
                    ]);
                }
            }
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            name: 'cgNotify',
                            files: ['css/plugins/angular-notify/angular-notify.min.css','/plugins/angular-notify/angular-notify.min.js']
                        }
                    ]);
                }
            }
        ...
        .state('miscellaneous.diff', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['/plugins/diff_match_patch/javascript/diff_match_patch.js']
                        },
                        {
                            name: 'diff-match-patch',
                            files: ['/plugins/angular-diff-match-patch/angular-diff-match-patch.js']
                        }
                    ]);
                }
            }
        ...
        .state('miscellaneous.live_favicon', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['/plugins/tinycon/tinycon.min.js']
                        }
                    ]);
                }
            }
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            seria: true,
                            files: ['/plugins/dataTables/jquery.dataTables.js','css/plugins/dataTables/dataTables.bootstrap.css']
                        },
                        {
                            files: ['/plugins/dataTables/dataTables.bootstrap.js']
                        },
                        {
                            name: 'datatables',
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            name: 'ngGrid',
                            files: ['/plugins/nggrid/ng-grid-2.0.3.min.js']
                        },
                        {
                            insertBefore: '#loadBefore',
                            files: ['/plugins/nggrid/ng-grid.css']
                        }
                    ]);
                }
            }
        ...
        .state('gallery.basic_gallery', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['/plugins/blueimp/jquery.blueimp-gallery.min.js','css/plugins/blueimp/css/blueimp-gallery.min.css']
                        }
                    ]);
                }
            }
