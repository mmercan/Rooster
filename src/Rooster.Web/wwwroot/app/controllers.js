...
function CalendarCtrl($scope) {
    ...
    $scope.events = [
        ...
        {title: 'Long Event',start: new Date(y, m, d - 5),end: new Date(y, m, d - 2),color:'brown'},
 ...
 */
function agileBoard($scope, notify) {
    ...
    $scope.AddnewTodo = function () {
        if ($scope.newTaskText == "") {
            notify({
                message: "don't let the text empty",
