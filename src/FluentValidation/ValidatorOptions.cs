...
namespace FluentValidation {
	...
	public static class ValidatorOptions {
		...
		static string GetDisplayName(MemberInfo member) {
            //var attributes = (from attr in member.GetCustomAttributes(true)  select new {attr, type = attr.GetType()}).ToList();

            var attributes = (from attr in member.CustomAttributes 
